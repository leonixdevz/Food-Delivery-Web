...
const defaultRestaurants = [
  {
    ...
    menu: [
      { name: "Grilled Chicken Combo", category: "chicken", price: "₦4,500", image: "../images/Chicken 3.jpeg", desc: "Tender grilled chicken with rice and sauce." },
      { name: "Spicy Chicken Bucket", category: "chicken", price: "₦6,800", image: "../images/Chicken Fried Chicken Recipe.jpeg", desc: "Crispy fried chicken for your family feast." },
      { name: "Chicken Burger", category: "burgers", price: "₦2,800", image: "../images/Chicken 4.jpeg", desc: "Juicy chicken burger with crunchy fries." },
      { name: "Rice & Chicken Box", category: "rice", price: "₦3,500", image: "../images/Jollof Rice With Chicken.jpeg", desc: "Flavor-packed rice with chicken and sauce." },
      // { name: "Crispy Chicken Wings", category: "chicken", price: "₦3,900", image: "../images/Jollof Rice With Chicken.jpeg", desc: "Finger-licking wings tossed in spicy seasoning." },
      { name: "Loaded Fries & Ketchup", category: "snacks", price: "₦3,000", image: "../images/fries.jpeg", desc: "Crispy fries with crunchy chicken nuggets and dip." },
      // { name: "Family Chicken Feast", category: "chicken", price: "₦8,200", image: "../images/Jollof Rice With Chicken.jpeg", desc: "A large combo for sharing with crispy chicken, rice, and sides." },
      // { name: "Hot Wings Combo", category: "snacks", price: "₦4,200", image: "../images/daisy.jpeg", desc: "Extra spicy wings with a creamy dip and fries." },
      { name: "Sausage Roll", category: "snacks", price: "₦800", image: "../images/Sausage%20Roll%20Recipe%20(Picnic%20Idea).jpeg", desc: "Warm sausage roll with flaky pastry and savory filling." },
      { name: "Sneaker Chocolate", category: "snacks", price: "₦1,000", image: "../images/Sneaker%20Chocolate.jpeg", desc: "Rich chocolate snack bar with a crunchy bite." },
      { name: "Iced Tea", category: "drinks", price: "₦700", image: "../images/iced-tea.jpeg", desc: "Chilled lemon iced tea to refresh your meal." },
      { name: "Plantain Chips", category: "snacks", price: "₦600", image: "../images/plantain-chips.jpeg", desc: "Crunchy plantain chips lightly salted." },
      { name: "Coleslaw", category: "sides", price: "₦500", image: "../images/coleslaw.jpeg", desc: "Fresh cabbage coleslaw with a creamy dressing." },
      { name: "Chocolate Milkshake", category: "drinks", price: "₦1,200", image: "../images/milkshake.jpeg", desc: "Thick chocolate milkshake topped with cream." },
      { name: "Classic Jollof Rice", category: "rice", price: "₦3,900", image: "../images/Jollof Rice With Chicken.jpeg", desc: "Spicy jollof rice served with chicken and plantain." },
      ...
      { name: "Stir-Fry Noodles", category: "noodles", price: "₦3,500", image: "../images/stir fry noodles.jpeg", desc: "Savory noodles tossed with chicken and veggies." }
    ]
  },
  {
    ...
    menu: [
      { name: "Amala & Ewedu", category: "swallow", price: "₦3,800", image: "../images/images%20(1).jpeg", desc: "Smooth amala with ewedu and assorted meat." },
      { name: "Egusi Soup Combo", category: "soups", price: "₦4,900", image: "../images/images.jpeg", desc: "Rich egusi soup with pounded yam and meat." },
      { name: "Jollof Rice Plate", category: "rice", price: "₦4,200", image: "../images/Jollof Rice With Chicken.jpeg", desc: "Party-style jollof rice with chicken." },
      { name: "Fried Rice", category: "soups", price: "₦3,200", image: "../images/Fried Rice.jpeg", desc: "Hot and spicy pepper soup with fish or chicken." },
      { name: "Kunu", category: "drinks", price: "₦1,000", image: "../images/kunu pepper.jpeg", desc: "A traditional non-alcoholic drink with a creamy grain taste." },
      ...
      { name: "Zobo Bottle", category: "drinks", price: "₦700", image: "../images/zobo.jpeg", desc: "Chilled zobo made with hibiscus and ginger." },
      { name: "Pepper Soup (Small)", category: "soups", price: "₦1,200", image: "../images/pepper-soup.jpeg", desc: "Light pepper soup to warm the stomach." },
      { name: "Plantain (Fried)", category: "sides", price: "₦600", image: "../images/plantain.jpeg", desc: "Fried ripe plantain to complement your meal." },
      { name: "Protein Salad", category: "salads", price: "₦2,500", image: "../images/protein-salad.jpeg", desc: "Mixed greens with egg, tuna and beans." },
      ...
      { name: "Yam Porridge", category: "rice", price: "₦3,600", image: "../images/images.jpeg", desc: "Creamy yam porridge with fish and aromatic peppers." },
      ...
      { name: "Fried Rice Plate", category: "rice", price: "₦4,300", image: "../images/Fried Rice.jpeg", desc: "Party-style jollof rice served with sides." },
      { name: "Coke Bottle", category: "drinks", price: "₦850", image: "../images/Coca%20cola.jpeg", desc: "A classic chilled Coca-Cola to enjoy with your meal." },
      { name: "7Up Bottle", category: "drinks", price: "₦850", image: "../images/7up.jpeg", desc: "Crisp 7Up soda for a refreshing lift." },
      { name: "Spicy Noodles Bowl", category: "noodles", price: "₦3,900", image: "../images/noodles%202.jpeg", desc: "Hot noodles with vegetables and rich spices." }
    ]
  },
  {
    slug: "pizza-hub",
    ...
    menu: [
      { name: "Pepperoni Pizza", category: "pizza", price: "₦5,400", image: "../images/Pizza%20on%20white%20background.jpeg", desc: "Cheesy pepperoni pizza baked to golden perfection." },
      { name: "Margherita Pizza", category: "pizza", price: "₦4,900", image: "../images/Delicious%20pizza.jpeg", desc: "A classic pizza with basil, mozzarella, and tomato." },
      { name: "Meat Lovers Pizza", category: "pizza", price: "₦6,300", image: "../images/Delicious%20pizza.jpeg", desc: "Loaded with premium meats and extra cheese." },
      { name: "Veggie Pizza", category: "pizza", price: "₦4,700", image: "../images/Delicious%20pizza.jpeg", desc: "Fresh vegetables and a creamy cheese finish." },
      { name: "Chicken Tikka Pizza", category: "pizza", price: "₦6,000", image: "../images/Delicious%20pizza.jpeg", desc: "A spicy pizza with grilled chicken and peppers." },
      ...
      { name: "Garlic Bread", category: "sides", price: "₦900", image: "../images/garlic-bread.jpeg", desc: "Toasted garlic bread with herb butter." },
      { name: "BBQ Chicken Wings", category: "snacks", price: "₦2,800", image: "../images/wings.jpeg", desc: "Sticky BBQ wings with a side of dip." },
      { name: "Iced Cappuccino", category: "drinks", price: "₦1,500", image: "../images/iced-coffee.jpeg", desc: "Chilled cappuccino with a coffee kick." },
      { name: "Fruit Salad", category: "desserts", price: "₦1,200", image: "../images/fruit-salad.jpeg", desc: "Seasonal fruit bowl with a light syrup." },
      ...
      { name: "Fried Rice Bowl", category: "rice", price: "₦3,800", image: "../images/Jollof Rice With Chicken.jpeg", desc: "Flavorful fried rice with vegetables and chicken." },
      ...
      { name: "Sprite Bottle", category: "drinks", price: "₦850", image: "../images/Sprite.jpeg", desc: "A sweet orange soda to finish your meal." },
      { name: "Chicken Noodles", category: "noodles", price: "₦3,700", image: "../images/noodles.jpeg", desc: "Comforting noodles with seasoned chicken and greens." }
    ]
  },
  {
    slug: "burger-king",
    ...
    menu: [
      ...
      { name: "Loaded Fries With Ketchup", category: "snacks", price: "₦1,500", image: "../images/fries.jpeg", desc: "Crunchy, seasoned fries with a rich dipping sauce." },
      ...
      { name: "Cheesy Fries", category: "snacks", price: "₦2,400", image: "../images/images%20(1).jpeg", desc: "Golden fries topped with melted cheese and herbs." },
      { name: "Onion Rings", category: "snacks", price: "₦900", image: "../images/onion-rings.jpeg", desc: "Crispy battered onion rings with dip." },
      { name: "Vanilla Milkshake", category: "drinks", price: "₦1,200", image: "../images/milkshake-vanilla.jpeg", desc: "Creamy vanilla milkshake with whipped cream." },
      { name: "Mozzarella Sticks", category: "snacks", price: "₦1,800", image: "../images/mozza-sticks.jpeg", desc: "Fried mozzarella sticks with marinara." },
      { name: "Iced Tea", category: "drinks", price: "₦700", image: "../images/iced-tea.jpeg", desc: "Lemon iced tea to cool your meal." },
      { name: "Jollof Rice Box", category: "rice", price: "₦3,500", image: "../images/Jollof Rice With Chicken.jpeg", desc: "A hearty jollof rice box served with a piece of chicken." },
      ...
      { name: "Spicy Noodles", category: "noodles", price: "₦3,800", image: "../images/noodles.jpeg", desc: "Spicy noodles with beef, peppers, and onions." }
    ]
  },
  {
    slug: "buka-hut",
    ...
    menu: [
      ...
      // { name: "Boiled Yam & Egg Sauce", category: "rice", price: "₦3,600", image: "../images/images%20(1).jpeg", desc: "Comfort food with rich egg sauce and herbs." },
      { name: "Small Chops with Meat", category: "Dessert", price: "₦7,500", image: "../images/chops.jpeg", desc: "A deeply spiced chops with spring rolls, puff puff, samosa with spiced meats made for meat lovers." },
      { name: "Jollof Rice", category: "Jollof Rice", price: "₦1,500", image: "../images/Jollof Rice With Chicken.jpeg", desc: "Golden plantain paired with spicy grilled meat." },
      { name: "Spicy Noodles Bowl", category: "noodles", price: "₦1,500", image: "../images/noodles 2.jpeg", desc: "Stir-fried noodles with peppers and a savory Nigerian twist." },
      ...
      { name: "Kunu", category: "drinks", price: "₦700", image: "../images/kunu.jpeg", desc: "A fizzy fruit blend with citrus notes and a chilled finish." },
      { name: "Coke Bottle", category: "drinks", price: "₦900", image: "../images/Coca%20cola.jpeg", desc: "Chilled Coca-Cola to refresh your meal." },
      { name: "Suya Skewers", category: "grill", price: "₦1,200", image: "../images/suya.jpeg", desc: "Spiced suya skewers with onions and pepper." },
      { name: "Small Pepper Soup", category: "soups", price: "₦1,000", image: "../images/pepper-soup.jpeg", desc: "A light pepper soup perfect as a starter." },
      { name: "Fried Plantain", category: "sides", price: "₦600", image: "../images/plantain.jpeg", desc: "Sweet fried plantain as a side." },
      { name: "Zobo Bottle", category: "drinks", price: "₦700", image: "../images/zobo.jpeg", desc: "Hibiscus zobo served chilled." },
      { name: "Monster Drink", category: "drinks", price: "₦900", image: "../images/Monster.jpeg", desc: "Sweet Fanta orange soda to brighten your order." },
      { name: "7Up Bottle", category: "drinks", price: "₦900", image: "../images/7up.jpeg", desc: "Crisp 7Up soda for a refreshing lift." },
...
async function initRestaurantPage() {
  ...
  if (menuGrid) {
    menuGrid.addEventListener('click', (event) => {
      ...
      const previewUrl = new URL('../preview-page/index.html', window.location.href);

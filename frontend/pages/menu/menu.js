...
function configureBackLink() {
  ...
  const restaurantPath = currentPreviewItem.restaurant
    ? `/pages/restaurants/index.html?restaurant=${encodeURIComponent(currentPreviewItem.restaurant)}`
    : '/pages/restaurants/index.html';
...
async function initializePreviewPage() {
  ...
  if (!item || !item.name) {
    ...
    if (backToMenuLink) backToMenuLink.href = '/pages/restaurants/index.html';
    return;
  }
